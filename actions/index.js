...
export const saveDeckTitle1 = (title) => dispatch => (
    DecksDatabase
        .saveDeckTitle1(title)
        .then(newDecks => dispatch(receiveDecks(newDecks)))
)

export const saveDeckTitle2 = (title) => dispatch => (
    DecksDatabase
        .saveDeckTitle2(title)
        .then(newDecks => dispatch(receiveDecks(newDecks)))
)

export const saveDeckTitle3 = (title) => dispatch => (
    DecksDatabase
        .saveDeckTitle3(title)
        .then(newDecks => dispatch(receiveDecks(newDecks)))
)
